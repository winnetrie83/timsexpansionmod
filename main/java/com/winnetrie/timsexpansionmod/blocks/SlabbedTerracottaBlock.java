...
public class SlabbedTerracottaBlock extends BlockBaseMetaColored implements IMetaBlock{
	...
	public SlabbedTerracottaBlock(String name, IBlockState modelState) {
