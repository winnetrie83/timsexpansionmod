...
public class BlockBaseWall extends BlockBaseMetaUniversal
{
    ...
    public BlockBaseWall(String name, IBlockState state)
    {
    ...
    public boolean canBeConnectedTo(IBlockAccess world, BlockPos pos, EnumFacing facing)
    {
        ...
        return connector instanceof BlockWall || connector instanceof BlockFenceGate || connector instanceof BlockBaseWall;
    }
