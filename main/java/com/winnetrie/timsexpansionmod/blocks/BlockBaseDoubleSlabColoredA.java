...
public class BlockBaseDoubleSlabColoredA extends BlockBaseSlabColoredA{
	
	private final Block singleSlab;

	
	public BlockBaseDoubleSlabColoredA(String name, IBlockState state, Block singleSlabReference) {
		super(name, state);
