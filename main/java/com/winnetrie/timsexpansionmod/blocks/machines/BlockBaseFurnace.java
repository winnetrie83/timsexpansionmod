package com.winnetrie.timsexpansionmod.blocks.machines;
...
public class BlockBaseFurnace extends BlockContainer implements IHasModel{
	
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
    private final boolean isBurning;
    private static boolean keepInventory;

    protected BlockBaseFurnace(boolean isBurning, String name, Material material)
    {
        super(material);
